...
from nvidia_tao_ds.api.api_utils import module_utils
from nvidia_tao_ds.core.entrypoint.entrypoint import launch
    ...
    while True:
        if queue:
            ...
            try: 
                ...
                use_ngc_staging = job["data"].get('use_ngc_staging', "True")
