...
"""Define entrypoint to run tasks for skin_tone."""

import argparse

from nvidia_tao_ds.skin_tone import scripts
...
def main():
    ...
    parser = argparse.ArgumentParser(
        "skin",
        add_help=True,
        description="TAO Toolkit entrypoint for skin_tone"
    )
    ...
    launch(vars(args), unknown_args, subtasks, network="skin_tone")
