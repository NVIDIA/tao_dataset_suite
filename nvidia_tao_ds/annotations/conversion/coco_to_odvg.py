...
def convert_coco_to_odvg(cfg, verbose=False):
    ...
    """
    coco_json_path = cfg.coco.ann_file
    odvg_jsonl_path = os.path.join(cfg.results_dir, os.path.basename(coco_json_path).replace(".json", "_odvg.jsonl"))
    use_all_categories = cfg.coco.use_all_categories
